...
export const ku: Dictionary = {
  ...
  letters: {
    title: "تیپ",
    subtitle: "ژ A هەتا Z دگەل Pinki",
    unitLabel: "یەکەیا {n}",
    unitRange: "ژ {from} هەتا {to}",
    challenge: "تاقیکرن",
    challengeAria: "تاقیکرنا یەکەیا {n}",
    challengeLockedAria: "تاقیکرنا یەکەیا {n}، قوفلکری",
    letterAria: "تیپا {letter} دەستپێبکە",
    letterLockedAria: "تیپا {letter}، قوفلکری",
    letterDoneAria: "تیپا {letter}، تەمام — دیسا بیاریێ بکە",
    book: "پەرتووکا تیپێن من",
    bookEmpty: "تیپەکێ تەمام بکە دا لاپەڕێ وێ پڕ ببیت!",
    bookClose: "پەرتووکێ بگرە",
    backToMap: "ڤەگەڕان بۆ تیپان",
    letterOf: "تیپا {letter}",
    unitChallenge: "تاقیکرنا یەکەیا {n}",
    videoAbout: "ڤیدیۆیەکا کورت دەربارەی تیپا {letter}",
    hearName: "ناڤێ تیپێ گوهداری بکە",
    hearSound: "دەنگێ تیپێ گوهداری بکە",
    hearWord: "{word} گوهداری بکە",
    listenAgain: "دیسا گوهداری بکە",
    traceAria: "تیپێ ب تلییا خۆ بشوپینە",
    bubbleAria: "پفدانکەکا ب تیپا {letter}",
    tileAria: "تیپا {letter}",
    slotAria: "جهێ {n} ژ {total}",
    complete: "تیپا {letter} تەمام بوو!",
    unlocked: "تیپا {letter} ڤەبوو!",
    challengeUnlocked: "تاقیکرنا یەکەیێ ڤەبوو!",
    unitComplete: "یەکەیا {n} تەمام بوو!",
    newPage: "لاپەڕەکێ نوو د پەرتووکا تیپێن تە دا!",
  },
  lettersPinki: {
    watch: "وەرە دا {letter} بنیاسین!",
    meet: "ئەڤە {letter}! {letter} وەکی {word}.",
    demoCapital: "بنێڕە ئەز چاوا {letter} یا مەزن دنڤیسم!",
    demoSmall: "نوکە {letter} یا بچویک!",
    trace: "دۆرا تەیە — بشوپینە!",
    traceMiss: "زۆر نێزیک بوو! دیسا هەول بدەین.",
    traceDone: "نڤیسینەکا جوان!",
    soundPick: "کیژ دەنگێ {letter} تێدایە؟",
    ...
    good: "زۆر باشە!",
    celebrate: "هوورا! تە {letter} فێربوو!",
    challenge: "هەر تشتێ تو دزانی نیشا من بدە!",
    challengeDone: "تە هەمی یەکە تەمام کر!",
  },
};
