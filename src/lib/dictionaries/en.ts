...
export const en = {
  ...
  /** Learn Letters — the map, the sessions and the Alphabet Book. The
      letters and the words they are taught with are English in every
      locale; only the chrome around them translates. */
  letters: {
    title: "Letters",
    subtitle: "From A to Z with Pinki",
    unitLabel: "Unit {n}",
    unitRange: "{from} to {to}",
    challenge: "Challenge",
    challengeAria: "Unit {n} challenge",
    challengeLockedAria: "Unit {n} challenge, locked",
    letterAria: "Start the letter {letter}",
    letterLockedAria: "The letter {letter}, locked",
    letterDoneAria: "The letter {letter}, done — play again",
    book: "My Alphabet Book",
    bookEmpty: "Finish a letter to fill its page!",
    bookClose: "Close the book",
    backToMap: "Back to the letters",
    letterOf: "Letter {letter}",
    unitChallenge: "Unit {n} challenge",
    videoAbout: "A short video about the letter {letter}",
    hearName: "Hear the letter's name",
    hearSound: "Hear the letter's sound",
    hearWord: "Hear {word}",
    listenAgain: "Listen again",
    traceAria: "Trace the letter with your finger",
    bubbleAria: "A bubble with the letter {letter}",
    tileAria: "The letter {letter}",
    slotAria: "Spot {n} of {total}",
    complete: "Letter {letter} complete!",
    unlocked: "Letter {letter} unlocked!",
    challengeUnlocked: "Unit challenge unlocked!",
    unitComplete: "Unit {n} complete!",
    newPage: "A new page in your Alphabet Book!",
  },
  /** Pinki's lines in a Letters session. `{letter}` is the capital letter,
      `{word}` a taught English word — neither ever translates. */
  lettersPinki: {
    watch: "Let's meet {letter}!",
    meet: "This is {letter}! {letter} is for {word}.",
    demoCapital: "Watch me write a big {letter}!",
    demoSmall: "Now a small {letter}!",
    trace: "Your turn — trace it!",
    traceMiss: "So close! Let's go again.",
    traceDone: "Beautiful writing!",
    soundPick: "Which one has the {letter} sound?",
    ...
    good: "Well done!",
    celebrate: "Hooray! You learned {letter}!",
    challenge: "Show me all you know!",
    challengeDone: "You finished the whole unit!",
  },
};
