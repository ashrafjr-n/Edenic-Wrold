 ...
 *
 * **The friend-world teaser leads the page, full-width, with the two
 * playable games below it.** It used to sit last, under the pair — moved to
 * the front on direct request, so it's the first thing a child sees rather
 * than a footnote under the games. It carried a third card, `WatchLearnCta`
  ...
  return (
    <main className="flex flex-1 flex-col justify-center px-4 py-10 sm:px-8 sm:py-14">
      <div className="mx-auto grid w-full max-w-5xl gap-6 sm:gap-8 lg:grid-cols-2">
        {/* Spans both columns, first in the grid — it is a teaser for a
            whole feature, not a third game, and leading the page at twice
            the width is what says so. */}
        <FriendWorldTeaser
          dict={dict}
