...
export const memoryLevels: MemoryLevel[] = [
  ...
  },
  {
    ...
    cols: 4,
    seconds: 60,
    faces: ["rabbit", "cloud", "ball", "blueBall", "pinki", "nova"],
  },

  {
    ...
    cols: 4,
    seconds: 85,
    faces: ["apple", "cat", "dog", "star", "ball", "blueBall", "a", "b"],
  },
  {
    value: 12,
    pairs: 8,
    cols: 4,
    seconds: 75,
    faces: ["pinki", "nova", "bloo", "ball", "blueBall", "a", "b", "c"],
  },
];
